<!-- Modal -->
<div class="modal fade" id="exampleModalNuevoReporte" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-magenta-dark">
                <h1 class="modal-title fs-5 text-white" id="exampleModalToggleLabel">
                    <i class="fas fa-plus-circle"></i> Nuevo Reporte de daño
                </h1>
            ...
            <div class="modal-body">
                <div id="nuevo-tipo-propiedad">
                    ...
                    <?php include './controller/reporteReparacion/nuevoReporte.php'; ?>

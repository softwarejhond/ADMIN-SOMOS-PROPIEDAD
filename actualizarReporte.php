        ...
        <div class="mt-3 mb-3">
            ...
            <div id="dashboard">
                <div class="position-relative">
                    <h2 class="position-absolute top-0 start-0 "><i class="bi bi-pencil-square"></i> Actualización de reporte</h2>
                ...
                <div class="row">
                    ...
                    <div class="col col-sm-12 col-md-12 col-lg-12">
                        <?php include("controller/reparaciones/actualizacionReporte.php"); ?>
                    </div>
                </div>

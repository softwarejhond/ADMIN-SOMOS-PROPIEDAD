        ...
        <div class="mt-3 mb-3">
            ...
            <div id="dashboard">
                <div class="position-relative">
                    <h2 class="position-absolute top-0 start-0 "><i class="bi bi-currency-dollar"></i> Propiedades disponibles</h2>
                ...
                <div class="row">
                    ...
                    <div class="col col-sm-12 col-md-12 col-lg-12">
                        <?php include("controller/propiedades/listaPropiedadesDisponibles.php"); ?>
                    </div>
                </div>
